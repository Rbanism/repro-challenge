The following checklist is not a list of requirements, i.e., you can even submit if none of the boxes are checked, but will be used to assess the level of reproducibility of your project.
